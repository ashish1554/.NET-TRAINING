...
namespace CTMS.Services
{
    public class DepartmentServices
    {
        ...
        public void DepartmentReport(AppDbContext context)
        {
            ...
            bool exists = context.Departments.Any(did=>did.DepartmentId==id);
            ...
            var dept = context.Departments.Include(e=>e.Employees).ThenInclude(en=>en.Enrollments).FirstOrDefault(d=>d.DepartmentId==id);
